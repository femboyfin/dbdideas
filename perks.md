...
⭐ Indicates our preferred change out of a series of "this or this" changes.


## Survivor Perks


### [Ace in the Hole](https://deadbydaylight.wiki.gg/wiki/Ace_in_the_Hole)
...
- Increase second slot maximum rarity from Uncommon to Rare
  - Provides a slight increase in the average strength of items retrieved, without any major changes

### [Adrenaline](https://deadbydaylight.wiki.gg/wiki/Adrenaline)

- Remove 3-second 50% Haste bonus and Exhausted status effect
  - Lowers the strength level by normalizing the value of the perk, removing it's secondary effect.


### [Aftercare](https://deadbydaylight.wiki.gg/wiki/Aftercare)

- Once you're hooked, no longer track the auras of the 2 longest tracked survivors, instead of resetting all auras
  - Makes an already weak perk that's primarily useful in low-party-size situations more consistent and therefore viable.


### [Alert](https://deadbydaylight.wiki.gg/wiki/Alert)

- Trigger aura reveal on vault in addition to break and damage actions ⭐
  - Adds an additional use case of a low tier perk, making it more well-rounded.

or

- Increase aura reveal duration to 10 seconds (from 5 seconds)
...
### [Any Means Necessary](https://deadbydaylight.wiki.gg/wiki/Any_Means_Necessary)

- Permanently reveal the aura of dropped pallets, even once picked up
  - Slight side benefit that lessens the mental workload of cataloging pallets over time as a reward for using the perk's primary purpose.


### [Apocalyptic Ingenuity](https://deadbydaylight.wiki.gg/wiki/Apocalyptic_Ingenuity)

- Change activation condition to repairing 40% of a generator (was unlock/rummage two chests)
...
- Reduce rebuild time to 3 seconds from 4 seconds
  - Slight numbers buff to an already relatively weak perk, without causing problems with unavoidable stuns.


### [Appraisal](https://deadbydaylight.wiki.gg/wiki/Appraisal)
...
- Increase action speed bonus from 40/60/80% to 60/80/100%
...
- Remove limitation of two rummages per chest ⭐
...
- Gain a token every time you deplete an item
...
- Adjust skillcheck healing progress by token to: 0/10/20/30/40/60
...
### [Background Player](https://deadbydaylight.wiki.gg/wiki/Background_Player)
...
- Reduce Exhaustion duration to 5 seconds.
  - Accidental activations are less punishing and allows easier synergy with other Exhaustion perks to be more viable.


### [Balanced Landing](https://deadbydaylight.wiki.gg/wiki/Balanced_Landing)

- Separate stagger reduction from Exhaustion (partially reverting 3.4.0)
  - Increases the consistency of map-specific, low-use exhaustion perk across a variety maps, potentially opening up the doors to unqiue plays in and out of chase that are otherwise unachievable


### [Bardic Inspiration](https://deadbydaylight.wiki.gg/wiki/Bardic_Inspiration)

- Remove range limitation (was 16m)
...
- Reduce cooldown to 52/44/36 seconds
...
### [Better Together](https://deadbydaylight.wiki.gg/wiki/Better_Together)

- In addition to other survivors seeing the generator you are on, you also see the generator other survivors are on.
...
- In addition to the survivor's aura, the aura of their generator is also revealed for 30 seconds.
...
### [Better than New](https://deadbydaylight.wiki.gg/wiki/Better_than_New)
...
### [Bite the Bullet](https://deadbydaylight.wiki.gg/wiki/Bite_the_Bullet)
...
- Increase penalty reduction to 2/1/0% (from 3/2/1%)
...
### [Blast Mine](https://deadbydaylight.wiki.gg/wiki/Blast_Mine)

- No longer blinds survivors within 12.5m of the generator
  - Removes the potential penalty to the user of the perk in addition to their teammates on a medicore perk.
- Blast mine stays inactive indefinitely, allowing multiple to be active at the same time.
...
- Add the buffer "linger" effect from Power of Two
...
- No longer has a 60 second cooldown ⭐
...
### [Boil Over](https://deadbydaylight.wiki.gg/wiki/Boil_Over)

- Grants the ability for all Survivors to read the Auras of all Hooks within 16m of the carried survivor
  - Turns the perk into a Leader-esque "come and help me" perk as well as an info perk.
- Increases the Sabotage speed of Survivors within 16m of the carried survivor by 15%
...
- Additionally shows your teammates where you are within the level-dependent range.
  - Quality of life change improving it further where it already performs best, in smaller party sizes.


### [Boon: Circle of Healing](https://deadbydaylight.wiki.gg/wiki/Boon:_Circle_of_Healing)
...
### [Boon: Dark Theory](https://deadbydaylight.wiki.gg/wiki/Boon:_Dark_Theory)

- Increase effect linger duration to 2/4/6 seconds (from 2/3/4)
  - Slight numbers buff to a low playrate perk without much risk for abuse.


### [Boon: Exponential](https://deadbydaylight.wiki.gg/wiki/Boon:_Exponential)
...
### [Boon: Illumination](https://deadbydaylight.wiki.gg/wiki/Boon:_Illumination)
...
- Increase Action speed bonus for cleansing to 25%
  - Increases the ability to use Illumination as an anti-Hex boon.
- Separate and increase Action speed bonus for blessing to 100%
...
- Effect lingers for 2/4/6 after leaving the Boon Totem's range
...
### [Boon: Shadow Step](https://deadbydaylight.wiki.gg/wiki/Boon:_Shadow_Step)
...
### [Borrowed Time](https://deadbydaylight.wiki.gg/wiki/Borrowed_Time)
...
- Increase Haste & Endurance effect to 11/13/15 seconds
...
- Increase altruistic healing speed by an additional 25% (to 35/65/75%)
  - Buff to the altruistic aspect of the perk without risking self-healing becoming too oppressive.


### [Breakdown](https://deadbydaylight.wiki.gg/wiki/Breakdown)

- If the killer is within 16m when you're unhooked, they're given 15% Hinder for 10 Seconds
...
- Reduce hook respawn time to 120 seconds (from 180)
...
- Increase range from 5 meters to 6 meters (partially reverts 7.1.0)
  - Slight buff to make the perk slightly safer, particularly in scenarios where the killer or survivor using it have a poor connection or the Killer is using Agitation.
...
- No longer require the item to be completely empty
...
### [Calm Spirit](https://deadbydaylight.wiki.gg/wiki/Calm_Spirit)

- Remove interaction speed penalties
  - The perk penalizing for using the perks own effects is really counterintuitive, this solves that.
...
- Reduce pause time to 22/26/30 seconds
...
- Reduce cooldown to 40/30/20 seconds (was 60/50/40)
...
### [Chemical Trap](https://deadbydaylight.wiki.gg/wiki/Chemical_Trap)
...
### [Clairvoyance](https://deadbydaylight.wiki.gg/wiki/Clairvoyance)
...
- Disconnect Broken from the perk timer to allow Vigil usage with it, meaning if you decide you want to get healed and preserve Clean Break for your next injure, you can.
  - Minor buff to an already strong perk creating the potential for creative uses of it via perk synergy.


### [Come and Get Me!](https://deadbydaylight.wiki.gg/wiki/Come_and_Get_Me!)

- In addition to revealing your Aura to the killer, reveal the Killer's aura to you for 5 seconds.
  - Helps with the goal of the perk which is to get the killer to chase you instead of the other survivor(s), allowing you to throw yourself in the killers face even if they tried to initially ignore you to tunnel.
...
### [Corrective Action](https://deadbydaylight.wiki.gg/wiki/Corrective_Action)

- Reveal the aura of the survivor who consumed a token until they finish their interaction.
...
- Turns Failed Skill Checks into Good Skill Checks and grants non-Med-Kit Good Skill Checks an additional 1%
...
### [Counterforce](https://deadbydaylight.wiki.gg/wiki/Counterforce)

- Change Totem Aura reveal from farthest to nearest
  - Significantly lessens travel time.
- Increase Totem Aura reveal to 20 seconds
...
### [Cut Loose](https://deadbydaylight.wiki.gg/wiki/Cut_Loose)
...
- Increase timer to 6/7/8 (was 4/5/6) seconds
...
### [Dance With Me](https://deadbydaylight.wiki.gg/wiki/Dance_With_Me)

- Activates upon Rushed Vaulting a pallet
  - Simply adds an additional method of activation to a relatively weak perk.


### [Dark Sense](https://deadbydaylight.wiki.gg/wiki/Dark_Sense)

- Decrease range to 16m (was 24m)
  - Increases the skill range where this perk is still reasonably useful.
- Increase Aura Reveal to 8/10/12 (was 5/7/10) seconds
...
### [Deadline](https://deadbydaylight.wiki.gg/wiki/Deadline)
...
### [Deception](https://deadbydaylight.wiki.gg/wiki/Deception)
